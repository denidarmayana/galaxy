...
/* Theme Panel Save */
	...
	themeOption['themeFullColor'] = ['public/assets/frontend/css/skin/skin-1','public/assets/frontend/css/skin/skin-2','public/assets/frontend/css/skin/skin-3','public/assets/frontend/css/skin/skin-4','public/assets/frontend/css/skin/skin-5','public/assets/frontend/css/skin/skin-6','public/assets/frontend/css/skin/skin-7','public/assets/frontend/css/skin/skin-8','public/assets/frontend/css/skin/skin-9','public/assets/frontend/css/skin/skin-10','themeFullColor_value','themeFullColor_logo'];
	...
	themeOption['bgImage'] =['bg1.jpg','error_404.html','error_404.html','error_404.html','bgImage_value'];
	themeOption['bgPatten'] =['pt1.jpg','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','error_404.html','bgPatten_value'];

jQuery(window).on('load', function(){
	
	jQuery(document).on('click', '.theme-color', function(){
        jQuery(".skin").attr("href", 'public/assets/frontend/css/skin/'+jQuery(this).data('color-theme')+'.css');
	...
	jQuery.each(themeOption, function(index, themeOptionItem) {
		...
		if(themeOptionItemValue != '' && themeOptionItemValue != '1'){
			...
			if(themeOptionItem == 'themeStandardColor'){
				...
				jQuery(".skin").attr("href", 'public/assets/frontend/css/skin/'+themeOptionItemValue+'.css');

...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			...
			jQuery(".nav-header .logo-abbr").attr("src", "'+base_url+'public/assets/images/logo-white.png");
	...
	jQuery("#nav_header_color_1").on('click',function(){
		jQuery(".nav-header .logo-abbr").attr("src", "error_404.html");
		setCookie('logo_src', 'error_404.html');
		return false;
    });
